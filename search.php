		...
		<div class="container box_1170">
			<div class="row">
				<div class="col-lg-8 post-list">
					<!-- Start Post Area -->
					<?php
                    $search_create = "SELECT * FROM posts WHERE post_title LIKE '%$search_box%'";
					$search_result = mysqli_query($con , $search_create);
					
                    $some_search = mysqli_num_rows($search_result);
                    if($some_search === 0){
					...
					<section class="post-area">
						<div class="single-post-item">
							...
							<a href="blog-details.php" class="primary-btn text-uppercase mt-15">continue Reading</a>
							<div class="post-box">
								<div class="d-flex">
									<div>
										<a href="#">
